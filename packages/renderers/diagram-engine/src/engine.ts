      ...
      switch (normalizedEngine) {
        ...
        default: {
          if (isGraphvizDiagramEngine(normalizedEngine)) {
            ...
            if (!adapter) {
              return {
                ...
                format: 'error',
                payload:
                  'Graphviz adapter is not configured for @supramark/diagram-engine.',
                error: {
                  code: 'unsupported_engine',
                  message: `${params.engine} requires a Graphviz adapter`,
                  details:
                    'Use @supramark/diagram-engine/web or @supramark/diagram-engine/rn to create the engine.',
                },
              };
            }
          ...
          return {
            ...
            error: {
              code: 'unsupported_engine',
              message: `${params.engine} is not supported by @supramark/diagram-engine`,
            },
          };
        }
      }
